...
async def _download_and_send(update: Update, context: ContextTypes.DEFAULT_TYPE, chat_id: int, youtube_url: str, duration: str = "N/A"):
    ...
    try:
        ...
        if not data.get("success") or not data.get("url"):
            ...
            await context.bot.send_message(chat_id, "❌ Cette musique dépasse 25 Mo.")
            return
        ...
        try:
            ...
            pass
        await context.bot.send_message(chat_id, "⚠️ Cette musique dépasse 25 Mo ou une erreur est survenue.")
